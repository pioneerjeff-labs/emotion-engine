...
状态：实验性。当前版本：[v0.2.1 - Persistence hardening and agent install guide](https://github.com/pioneerjeff-labs/emotion-engine/releases/tag/v0.2.1)。
...
| 让 coding agent 帮你本地接入 | [INSTALL_WITH_AGENT.md](INSTALL_WITH_AGENT.md) |
| 连接支持 MCP 的本地 agent | [docs/MCP.md](docs/MCP.md) |
...
| Coding-agent 辅助本地安装 | [INSTALL_WITH_AGENT.md](INSTALL_WITH_AGENT.md) |
| 本地 stdio MCP runtime/protocol tools | [docs/MCP.md](docs/MCP.md) |
...
- **PAD 状态**：愉悦度、唤醒度、主导感
- **短期 affective pulse**：每轮事件带来的可见情绪波动，和慢速 PAD mood 分开
- **波动档位**：`steady`、`expressive`、`dramatic_test`，用于区分工作助手、陪伴角色和戏剧化测试
